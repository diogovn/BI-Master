# Detecção de falha em equipamentos rotativos através de análise de vibração utilizando Redes Neurais
...
![Pontos de medição de vibração no conjunto moto-bomba. À esquerda, o motor, e à direita, a bomba.](pontos de medicao.png)
